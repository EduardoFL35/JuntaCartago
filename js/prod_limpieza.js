function funcion_modal_editar_producto (){
    //Guardar Factura
    ...
    //Agregar Producto
    jQuery("#producto_form_editar").submit(function(){/*Acordarse que el # indica el id a la que se le da click*/
        var nombre_producto_editar = jQuery("#nombre_producto_editar").val();
        var precio_producto_editar = jQuery("#precio_producto_editar").val();
        var cantidad_producto_editar = jQuery("#cantidad_producto_editar").val();
        var cantidad_minima_producto_editar = jQuery("#cantidad_minima_producto_editar").val();
        var nombre_factura_editar = jQuery("#nombre_factura_editar").val();
        var nombre_imagen_editar = jQuery("#nombre_imagen_editar").val();
        var desc_producto_editar = jQuery("#desc_producto_editar").val();
        var id_producto_editar = jQuery("#id_producto_editar").val();
        jQuery("#nombre_producto_editar").css("border", "");
        jQuery("#precio_producto_editar").css("border", "");
        jQuery("#cantidad_product_editaro").css("border", "");
        jQuery("#cantidad_minima_producto_editar").css("border", "");
        jQuery("#desc_producto_editar").css("border", "");
        
        if (nombre_producto_editar == "") {
            jQuery("#nombre_producto_editar").css("border", "2px solid red");
            return false;
        }
        if (precio_producto_editar == "") {
            jQuery("#precio_producto_editar").css("border", "2px solid red");
            return false;
        }
        if (cantidad_producto_editar == "") {
            jQuery("#cantidad_producto_editar").css("border", "2px solid red");
            return false;
        }
        if (cantidad_minima_producto_editar == "") {
            jQuery("#cantidad_minima_producto_editar").css("border", "2px solid red");
            return false;
        }
        if (desc_producto_editar == "") {
            jQuery("#desc_producto_editar").css("border", "2px solid red");
            return false;
        }
        ...
        jQuery.ajax({
            ...
            dataType:"text",
            data:{
                key_editar_producto: "edit_producto",
                id_producto_editar : id_producto_editar,
                nombre_producto_editar : nombre_producto_editar,
                precio_producto_editar : precio_producto_editar,
                cantidad_producto_editar : cantidad_producto_editar,
                cantidad_minima_producto_editar : cantidad_minima_producto_editar,  
                nombre_factura_editar : nombre_factura_editar,  
                nombre_imagen_editar : nombre_imagen_editar,
                desc_producto_editar : desc_producto_editar
            },             
            success:function(ndata){  
                ...
                switch (ndata) {
                    case "1":
                        ...
                        jQuery("#alerta_registro").html("¡Se actualizó un producto correctamente!")
...
jQuery(document).ready( function () {
    ...
    //Editar Producto
    jQuery(".editar-producto-btn").click(function(){
        var id_edit_producto = jQuery(this).attr("data_id");
        jQuery.ajax({
			type: "POST", 
			url: "../../ajax/AProd_Limpieza",
			dataType:"text",
			data:{
				key_editar: "editar_producto",
				id_edit_producto: id_edit_producto
			},             
			success:function(ndata){  
				switch (ndata) {
                    case "a":
