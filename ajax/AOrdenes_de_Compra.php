...
//Insertar Doc
if(isset($_POST['key_registro_orden']) == "registro_orden"){
    $tipo_orden = $_POST['tipo_orden'];
    $estado_factura = $_POST['estado_factura']; 
    $fecha_orden = $_POST['fecha_orden'];
    $procedencia_orden = $_POST['procedencia_orden'];
    //$nombre_archivo = "archivos/".$_POST['nombre_archivo'];
    $desc_orden = $_POST['desc_orden'];
    $id_usuario = $_SESSION["id_user"];
    
    

    $sql = "INSERT INTO `ordenes_de_compra`(`descripcion`, `id_tipo_orden`, `id_estado_factura`, `fecha`, `id_procedencia`, `estado`, `id_usuario`) 
                            VALUES ('".$desc_orden."',".$tipo_orden.",".$estado_factura.",'".$fecha_orden."',".$procedencia_orden.", 1, ".$id_usuario.")";
