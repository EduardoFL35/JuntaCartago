...
$query = $conn->query("select * from ordenes_de_compra where id_tipo_orden = 2"); 
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Ordenes De Compra Ordinarias
                    </h2>
                </div>
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="Ordenes_PANEA.php" style="color: #ffffff; background-color: #001F3F;" class="btn d-none d-sm-inline-block">
