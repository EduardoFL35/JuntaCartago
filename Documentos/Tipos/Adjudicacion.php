...
$query = $conn->query("select * from documento where tipo_documento = 3"); 
...
<head>
    ...
    <script src="../../js/tipo_doc.js"></script>
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Adjudicaciones
                    </h2>
                </div>
                <!-- Page title actions -->
                                            ...
                                            <div class="btn-list flex-nowrap">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a id="btn_editar_tipo" class="editar-tipo-btn dropdown-item" data-bs-toggle="modal" data_id="<?php echo $id;?>" data-bs-target="#modalEditarTipo">
