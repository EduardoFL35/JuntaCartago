...
$query = $conn->query("select * from documento where tipo_documento = 6"); 
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Ordenes de Compra
                    </h2>
                </div>
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="../../Documentos/Ordenes_de_Compra/registro.php" style="color: #ffffff; background-color: #001F3F;" class="btn d-none d-sm-inline-block">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
