...
$query = $conn->query("select * from solicitudes where id_procedencia = 2"); 

if($_SESSION["rol"] != 2){//Redirecciono a una página cuando no tiene permisos
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Solicitudes Del Kinder Jesus Jimenez
                    </h2>
                </div>
                <!-- Page title actions -->
