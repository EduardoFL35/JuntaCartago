...
$query = $conn->query("select * from solicitudes where id_procedencia = 3"); 

if($_SESSION["rol"] != 4){//Redirecciono a una página cuando no tiene permisos
...
<head>
    ...
    <title>Solicitudes de Archivos - Junta De Cartago</title>
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Solicitudes De La Escuela Esquivel
                    </h2>
                </div>
                <!-- Page title actions -->
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="../Solicitudes/Registro_Solicitud.php" style="color: #ffffff; background-color: #001F3F;" class="btn d-none d-sm-inline-block">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="td-list"><a class="link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover" 
                                                                            href="http://localhost/Proyecto/Git/JuntaCartago/js/<?php echo $solicitud; ?>">Ver Solicitud</a></td>
