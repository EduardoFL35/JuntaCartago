...
$query = $conn->query("select * from solicitudes where id_procedencia = 5"); 

if($_SESSION["rol"] != 5){//Redirecciono a una página cuando no tiene permisos
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                    <i class="m-4 bi bi-folder-check"></i>Solicitudes Del La Escuela Padre Peralta
                    </h2>
                </div>
                <!-- Page title actions -->
