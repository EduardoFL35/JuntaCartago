                ...
                <div class="row pt-3 pb-2 mb-3 g-2 align-items-center border-bottom">
                    <div class="col">
                        ...
                        <div class="page-pretitle">
                            Listado de activos almacenados
                        </div>
                        <h2 class="page-title">
                            Control de Activos
                        </h2>
                    ...
                    <div class="col-12 col-md-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="Activos/registro.php" style="color: #ffffff; background-color: #001F3F;" class="btn d-none d-sm-inline-block">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="td-list"><a class="link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover" 
                                                                            href="http://localhost/Proyecto/Git/JuntaCartago/js/<?php echo $Factura; ?>">Descargar Factura</a></td>
